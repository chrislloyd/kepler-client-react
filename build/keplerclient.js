...
/***/ function(module, exports, __webpack_require__) {
	...
	var WebSocket = __webpack_require__(2);
	...
	var KeplerClient = (function () {
	  ...
	  function KeplerClient(host, elementOrDrawFn) {
	    ...
	    if (typeof elementOrDrawFn === 'function') {
	      ...
	      this._drawFn = function (state) {
	        Display = Display || __webpack_require__(4);
	  ...
	  _createClass(KeplerClient, [{
	    ...
	    key: '_handleMessage',
	    value: function _handleMessage(ev) {
	      var _this = this;
	
	      var state = Immutable.fromJS(JSON.parse(ev.data));
	      this._drawFn(state);
	      this.doUpdate(state);
	      this.state = state;
	      this._actions.map(function (action) {
	        _this._ws.send(JSON.stringify(action));
	      });
	      this._actions = [];
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapView = __webpack_require__(161);
	var HUD = __webpack_require__(182);
	
	function draw(state, element) {
	  var _state$toJS = state.toJS();
	
	  var me = _state$toJS.me;
	  var sensors = _state$toJS.sensors;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EntitySelf = __webpack_require__(180);
	
	var KeplerMap = React.createClass({
	  displayName: 'KeplerMap',
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(EntitySelf, { pos: this.props.pos })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cloneWithProps = __webpack_require__(171);
	...
	if ("production" !== process.env.NODE_ENV) {
	  ...
	  React.addons.TestUtils = __webpack_require__(179);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign = __webpack_require__(17);
	var emptyFunction = __webpack_require__(20);
	var joinClasses = __webpack_require__(173);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Entity = __webpack_require__(181);
	
	var MAX_HISTORY = 10;
	
	var EntitySelf = React.createClass({
	  displayName: 'EntitySelf',
	  ...
	  renderHistory: function renderHistory(state, age) {
	    var opacity = (MAX_HISTORY - age) / (3 * MAX_HISTORY);
	    return React.createElement(Entity, { pos: state.pos, opacity: opacity, key: age });
	  },
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      history.map(function (s, i) {
	        return _this.renderHistory(s, i);
	      }),
	      React.createElement(Entity, { pos: pos })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeplerHUD = React.createClass({
	  displayName: 'KeplerHUD',
...
/***/ }
/******/ ]);
//# sourceMappingURL=keplerclient.js.map